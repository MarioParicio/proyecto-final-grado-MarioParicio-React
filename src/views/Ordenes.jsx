    ...
    return (
        ...
        <div className='grid grid-cols-2 gap-5'>
            {filteredOrders.map(order => (
                <div key={order.id} className='p-5 bg-white shadow space-y-2 border-b flex flex-col justify-between'>
                    <div>
                    ...
                    <div>
                        ...
                        <p className='text-lg font-bold text-amber-600 mb-5'>
                        {order.paid ? 
                            <><span className=' text-green-600 font-bold'>Pagado </span><FaCheck color="green" className='ml-3'/></> :
